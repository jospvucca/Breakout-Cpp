...
int main(int argc, char* args[])
{
	...
	Game game = Game(800, 950, (std::filesystem::current_path().append("Resources\\Assets\\Fonts\\LTCushion-Black.ttf").string()).c_str(), "Brick Breaker", config, levelConfigData);
